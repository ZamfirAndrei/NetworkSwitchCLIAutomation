...
class TestSanitySuite1:
    ...
    def test_func_1(self):
        ...
        result = DUT1.sanity.download_image_ssh(mode="tftp", server_ip="10.2.109.24", img="5.0.2-r2")
        ...
        assert software_version["CNS Software Version"] == "5.0.2-r2"
        assert model_name["Model Name"] == "EX2028-P"
    ...
    def test_func_2(self):
        ...
        result = DUT1.sanity.download_image_ssh(mode="sftp", server_ip="10.2.109.24", img="5.1.0-e8", user="cambium",password="cambium123")
    ...
    def test_func_4(self):
        ...
        DUT1.sanity.copy_running_config_ssh(mode="tftp", server_ip="10.2.109.24", user="cambium",password="cambium123", path="/AGZamfir/Andrei-2028.conf")
        ...
        result = DUT1.sanity.retrieve_config_from_server_ssh(mode="tftp", server_ip="10.2.109.24", path="/AGZamfir/Andrei-2028.conf")
